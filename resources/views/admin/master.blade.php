        ...
        <div class="container-fluid" data-layout="container">
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="display: none;">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="{{ url('admin/dashboard') }}">
                        <div class="d-flex align-items-center"><span class="font-sans-serif text-primary">ShopHV</span></div>
                    </a>
                    ...
                    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="avatar avatar-xl">
                                    <img class="rounded-circle" src="{{ asset('images/avatar/admin.png')}}" alt="admin.png" />
                                </div>
                            </a>
